This project provides a Named Entity Recognition (NER) solution specifically designed for Greek documents in the archaeological domain. 
...
### Dataset Inventory
| DocType | Path | Document Count | Total Labels |
| :--- | :--- | :--- | :--- |
| | | | |
| | | | |
...
- Interaction Flow: Wait for explicit instructions.
- Formatting: Use standard markdown with concise, dry phrasing.
- Scratch scripts: Use the project's local tmp/ directory for any temporary or scratch scripts. This directory must be in .gitignore.
